...
class BadRequestException(PlatformException):
    ...
    def __init__(self, message: str = "Bad request parameter", details: dict[str, Any] | None = None) -> None:
...
class ForbiddenException(PlatformException):
    ...
    def __init__(self, message: str = "Action forbidden", details: dict[str, Any] | None = None) -> None:
...
class ConflictException(PlatformException):
    ...
    def __init__(self, message: str = "Resource state conflict", details: dict[str, Any] | None = None) -> None:
