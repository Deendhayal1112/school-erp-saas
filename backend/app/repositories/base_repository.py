...
class BaseRepository(Generic[ModelType]):
    ...
    async def create(self, entity: ModelType) -> ModelType:
        ...
        try:
            ...
            raise DuplicateEntityError(f"Database record collision: {e!s}") from e
        except SQLAlchemyError as e:
            await self.session.rollback()
            raise DatabaseError(f"Failed to insert database entity: {e!s}") from e
    ...
    async def get_by_id(self, id: Any) -> ModelType | None:
        ...
        try:
            ...
            raise DatabaseError(f"Failed to query database entity by ID: {e!s}") from e
    ...
    async def delete(self, entity: ModelType) -> None:
        ...
        try:
            ...
            await self.session.rollback()
            raise DatabaseError(f"Failed to delete database entity: {e!s}") from e
    ...
    async def count(self) -> int:
        ...
        try:
            ...
            raise DatabaseError(f"Failed to count database records: {e!s}") from e
