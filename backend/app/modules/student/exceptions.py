...
class StudentNotFoundException(NotFoundException):
    ...
    def __init__(
        self, message: str = "Student not found", details: dict[str, Any] | None = None
    ) -> None:
...
class DuplicateAdmissionNumberException(ConflictException):
    ...
    def __init__(
        self,
        message: str = "Admission number already registered in this school",
...
class DuplicateEmailException(ConflictException):
    ...
    def __init__(
        self,
        message: str = "Student email already registered",
        details: dict[str, Any] | None = None,
    ) -> None:
        super().__init__(message, details)
...
class InvalidAgeException(BadRequestException):
    ...
    def __init__(
        self,
        message: str = "Student age must be between 2 and 30 years old",
        details: dict[str, Any] | None = None,
    ) -> None:
        super().__init__(message, details)
...
class InvalidAdmissionDateException(BadRequestException):
    ...
    def __init__(
        self,
        message: str = "Invalid joined or graduation date",
        details: dict[str, Any] | None = None,
    ) -> None:
        super().__init__(message, details)
...
class StudentAlreadyExistsException(ConflictException):
    ...
    def __init__(
        self,
        message: str = "Student record already exists",
        details: dict[str, Any] | None = None,
    ) -> None:
        super().__init__(message, details)
