...
class SectionBase(BaseModel):
    name: str = Field(..., min_length=1, max_length=50, description="Section Name (e.g. Section A)")
    code: str = Field(..., min_length=1, max_length=50, description="Section Code (e.g. SEC-A-G1)")
    display_name: str = Field(..., min_length=1, max_length=50, description="Section display label")
    description: str | None = Field(None, description="Optional description details")
    capacity: int = Field(..., ge=1, description="Student enrollment capacity for this section")
    display_order: int = Field(..., ge=0, description="Sorting priority within the class")
