...
down_revision: Union[str, Sequence[str], None] = '5fd509cc4d99'
...
def upgrade() -> None:
    ...
    op.create_table('student_medical_records',
    ...
    op.create_index(op.f('ix_student_medical_records_id'), 'student_medical_records', ['id'], unique=False)
    op.create_index(op.f('ix_student_medical_records_school_id'), 'student_medical_records', ['school_id'], unique=False)
    op.create_index(op.f('ix_student_medical_records_student_id'), 'student_medical_records', ['student_id'], unique=True)
    ...
    sa.Column('severity', sa.Enum('LOW', 'MEDIUM', 'HIGH', 'SEVERE', name='allergyseverity'), nullable=False),
    ...
    sa.Column('is_deleted', sa.Boolean(), nullable=False),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['medical_record_id'], ['student_medical_records.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_allergies_id'), 'allergies', ['id'], unique=False)
    op.create_index(op.f('ix_allergies_medical_record_id'), 'allergies', ['medical_record_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_student_medical_records_school_id'), table_name='student_medical_records')
    op.drop_index(op.f('ix_student_medical_records_id'), table_name='student_medical_records')
