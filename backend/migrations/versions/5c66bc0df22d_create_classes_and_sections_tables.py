...
down_revision: Union[str, Sequence[str], None] = '65b0bdeeb244'
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PLANNED', 'ACTIVE', 'INACTIVE', 'ARCHIVED', name='sectionstatus'), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('class_id', 'display_order', name='uq_sections_class_display_order'),
